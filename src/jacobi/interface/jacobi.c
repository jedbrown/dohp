...
#endif
  err = PetscHeaderCreate(jac,p_dJacobi,struct _dJacobiOps,dJACOBI_CLASSID,"dJacobi","Basis and quadrature service","Jacobi",comm,dJacobiDestroy,dJacobiView);dCHK(err);
